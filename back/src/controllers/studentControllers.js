...
// Esto sirve para...
const createStudent = async (nombres, apellidos, dni, genero, fechaNacimiento, edad, email, plan, id_departamento)=>{
...
// Esto sirve para...  
    ...
    const newStudent = await Estudiante.create({nombres, apellidos, dni, genero, fechaNacimiento, edad, email, id_plan, id_departamento})
    return newStudent;
}
...
const updateStudent = async(id, nombres, apellidos, dni, genero, fechaNacimiento, edad, email, id_departamento, id_plan)=>{
    ...
    const studentUpdate = await findStudent.update({nombres, apellidos, dni, genero, fechaNacimiento, edad, email, id_departamento, id_plan })
