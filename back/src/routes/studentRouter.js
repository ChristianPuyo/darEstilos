...
studentRouter.post("/", async (req, res)=>{
    ...
    const { nombres, apellidos, dni, genero, fechaNacimiento, edad, email, plan, id_departamento } = req.body;
    
        try {
            const newStudent = await createStudent(nombres, apellidos, dni, genero, fechaNacimiento, edad, email, plan, id_departamento)
